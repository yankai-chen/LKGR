...
if __name__ == '__main__':
    ...
    parser.add_argument('--node_dim', type=int, default=32, help='the dimension of users, items and entities')
    parser.add_argument('--n_layer', type=int, default=1, help='the number of layers')
    parser.add_argument('--batch_size', type=int, default=4096, help='batch size.')
    parser.add_argument('--sample_size', type=int, default=4, help='the size of neighbors sampled')
    parser.add_argument('--agg_type', type=str, default='concat', help='specify the type of aggregation for users from [sum, concat, ngh]')
